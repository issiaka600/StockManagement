...
public class CommandLineClientValidator {

    public static List<String> validate(CommandLineClientDTO dto){
    ...
    public static List<String> updateValidation(CommandLineClientDTO dto){
        List<String> errors = new ArrayList<>();
        if (dto==null){
            errors.add("Veuillez renseigner l'identifiant de la ligne de commande client");
            ...
            if (dto.getId() == null){
                ...
                if (dto.getId().isBlank()){
                    errors.add("Veuillez renseigner un identifiant correct pour la ligne de commande client");
                }
            }
